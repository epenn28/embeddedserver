...
class Ui_PacMan(object):
    def setupUi(self, PacMan):
        PacMan.setObjectName("PacMan")
        PacMan.resize(482, 455)
        self.centralWidget = QtWidgets.QWidget(PacMan)
        ...
        PacMan.setCentralWidget(self.centralWidget)
        self.statusBar = QtWidgets.QStatusBar(PacMan)
        self.statusBar.setObjectName("statusBar")
        PacMan.setStatusBar(self.statusBar)

        self.retranslateUi(PacMan)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(PacMan)
        PacMan.setTabOrder(self.tabWidget, self.ipValue)
        PacMan.setTabOrder(self.ipValue, self.startButton)
        PacMan.setTabOrder(self.startButton, self.stopButton)
        PacMan.setTabOrder(self.stopButton, self.forwardValue)
        PacMan.setTabOrder(self.forwardValue, self.leftValue)
        PacMan.setTabOrder(self.leftValue, self.rightValue)
        PacMan.setTabOrder(self.rightValue, self.yValue)
        PacMan.setTabOrder(self.yValue, self.headingValue)
        PacMan.setTabOrder(self.headingValue, self.xValue)
        PacMan.setTabOrder(self.xValue, self.commandValue)
        PacMan.setTabOrder(self.commandValue, self.rightValue_2)
        PacMan.setTabOrder(self.rightValue_2, self.ipValue_2)
        PacMan.setTabOrder(self.ipValue_2, self.headingValue_2)
        PacMan.setTabOrder(self.headingValue_2, self.yValue_2)
        PacMan.setTabOrder(self.yValue_2, self.xValue_2)
        PacMan.setTabOrder(self.xValue_2, self.commandValue_2)
        PacMan.setTabOrder(self.commandValue_2, self.leftValue_2)
        PacMan.setTabOrder(self.leftValue_2, self.forwardValue_2)
        PacMan.setTabOrder(self.forwardValue_2, self.rightValue_3)
        PacMan.setTabOrder(self.rightValue_3, self.ipValue_3)
        PacMan.setTabOrder(self.ipValue_3, self.headingValue_3)
        PacMan.setTabOrder(self.headingValue_3, self.yValue_3)
        PacMan.setTabOrder(self.yValue_3, self.xValue_3)
        PacMan.setTabOrder(self.xValue_3, self.commandValue_3)
        PacMan.setTabOrder(self.commandValue_3, self.leftValue_3)
        PacMan.setTabOrder(self.leftValue_3, self.forwardValue_3)

    def retranslateUi(self, PacMan):
        _translate = QtCore.QCoreApplication.translate
        PacMan.setWindowTitle(_translate("PacMan", "MainWindow"))
        self.ipLabel.setText(_translate("PacMan", "<html><head/><body><p>IP address:</p></body></html>"))
        self.forwardLabel.setText(_translate("PacMan", "<html><head/><body><p>Forward IR:</p></body></html>"))
        self.leftLabel.setText(_translate("PacMan", "<html><head/><body><p>Left IR:</p></body></html>"))
        self.rightLabel.setText(_translate("PacMan", "<html><head/><body><p>Right IR:</p></body></html>"))
        self.xLabel.setText(_translate("PacMan", "<html><head/><body><p>X-coordinate:</p></body></html>"))
        self.yLabel.setText(_translate("PacMan", "<html><head/><body><p>Y-coordinate:</p></body></html>"))
        self.headingLabel.setText(_translate("PacMan", "<html><head/><body><p>Heading:</p></body></html>"))
        self.commandLabel.setText(_translate("PacMan", "<html><head/><body><p>Current command:</p></body></html>"))
        self.irStatusLabel.setText(_translate("PacMan", "IR status:"))
        self.lfStatusLabel.setText(_translate("PacMan", "LF status:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.pacmanTab), _translate("PacMan", "Pac-Man"))
        self.ipLabel_2.setText(_translate("PacMan", "<html><head/><body><p>IP address:</p></body></html>"))
        self.forwardLabel_2.setText(_translate("PacMan", "<html><head/><body><p>Forward IR:</p></body></html>"))
        self.leftLabel_2.setText(_translate("PacMan", "<html><head/><body><p>Left IR:</p></body></html>"))
        self.rightLabel_2.setText(_translate("PacMan", "<html><head/><body><p>Right IR:</p></body></html>"))
        self.xLabel_2.setText(_translate("PacMan", "<html><head/><body><p>X-coordinate:</p></body></html>"))
        self.yLabel_2.setText(_translate("PacMan", "<html><head/><body><p>Y-coordinate:</p></body></html>"))
        self.headingLabel_2.setText(_translate("PacMan", "<html><head/><body><p>Heading:</p></body></html>"))
        self.commandLabel_2.setText(_translate("PacMan", "<html><head/><body><p>Current command:</p></body></html>"))
        self.irStatusLabel_2.setText(_translate("PacMan", "IR status:"))
        self.lfStatusLabel_2.setText(_translate("PacMan", "LF status:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.ghost1Tab), _translate("PacMan", "Ghost 1"))
        self.ipLabel_3.setText(_translate("PacMan", "<html><head/><body><p>IP address:</p></body></html>"))
        self.forwardLabel_3.setText(_translate("PacMan", "<html><head/><body><p>Forward IR:</p></body></html>"))
        self.leftLabel_3.setText(_translate("PacMan", "<html><head/><body><p>Left IR:</p></body></html>"))
        self.rightLabel_3.setText(_translate("PacMan", "<html><head/><body><p>Right IR:</p></body></html>"))
        self.xLabel_3.setText(_translate("PacMan", "<html><head/><body><p>X-coordinate:</p></body></html>"))
        self.yLabel_3.setText(_translate("PacMan", "<html><head/><body><p>Y-coordinate:</p></body></html>"))
        self.headingLabel_3.setText(_translate("PacMan", "<html><head/><body><p>Heading:</p></body></html>"))
        self.commandLabel_3.setText(_translate("PacMan", "<html><head/><body><p>Current command:</p></body></html>"))
        self.irStatusLabel_3.setText(_translate("PacMan", "IR status:"))
        self.lfStatusLabel_3.setText(_translate("PacMan", "LF status:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.ghost2Tab), _translate("PacMan", "Ghost 2"))
        self.ghost1AdjustLeftButton.setText(_translate("PacMan", "↖"))
        self.pacAdjustLeftButton.setText(_translate("PacMan", "↖"))
        self.pacUpButton.setText(_translate("PacMan", "^"))
        self.ghost1LeftButton.setText(_translate("PacMan", "<"))
        self.ghost1RightButton.setText(_translate("PacMan", ">"))
        self.ghost2AdjustLeftButton.setText(_translate("PacMan", "↖"))
        self.ghost2UpButton.setText(_translate("PacMan", "^"))
        self.ghost2AdjustRightButton.setText(_translate("PacMan", "↗"))
        self.ghost2LeftButton.setText(_translate("PacMan", "<"))
        self.ghost2RightButton.setText(_translate("PacMan", ">"))
        self.ghost1UpButton.setText(_translate("PacMan", "^"))
        self.ghost1ControlLabel.setText(_translate("PacMan", "Ghost 1"))
        self.pacAdjustRightButton.setText(_translate("PacMan", "↗"))
        self.pacLeftButton.setText(_translate("PacMan", "<"))
        self.pacControlLabel.setText(_translate("PacMan", "Pac-Man"))
        self.pacRightButton.setText(_translate("PacMan", ">"))
        self.ghost1AdjustRightButton.setText(_translate("PacMan", "↗"))
        self.ghost2ControlLabel.setText(_translate("PacMan", "Ghost 2"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.manualTab), _translate("PacMan", "Manual Control"))
        self.startButton.setText(_translate("PacMan", "Start"))
        self.stopButton.setText(_translate("PacMan", "Stop"))
        self.statusLabel.setText(_translate("PacMan", "Server status:"))
        self.statusValue.setText(_translate("PacMan", "Inititalizing"))
        self.overrideButton.setText(_translate("PacMan", "Manual Override"))
        self.automaticButton.setText(_translate("PacMan", "Automatic Mode"))
        self.scoreLabel.setText(_translate("PacMan", "<html><head/><body><p align=\"center\">Score:</p></body></html>"))
        self.scoreValue.setText(_translate("PacMan", "<html><head/><body><p><span style=\" font-size:12pt;\">0</span></p></body></html>"))
